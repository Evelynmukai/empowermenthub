...
?>
	...
	<div class="col-md-12 form-group">		
		...
		<div id="div_cashondelivery">
			<hr>
			<center><input type="submit" name="submitdetail" id="submitdetail" value="Click here to Submit" autofocus class="btn btn-success"></center>
		</div>
	</div>	
