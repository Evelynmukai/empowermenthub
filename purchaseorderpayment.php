	...
	if(isset($_POST['submit'])) {
		...
		if(!mysqli_query($con,$sql)){
			...
			if($smsstatus == "Enabled")
			{
				...
				$msg= "Your payment bill for the produce " . $rssellerproduct['title'] ." has been made.";
				send_sms($mobno,$msg);
			}
			//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
			//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
          ...
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="100">
            <div class="info mt-4 ">
									...
									<div class="form-row">
										...
										<div class="col-md-6 form-group">
											<button type="submit" name="submit" id="submit" class="btn btn-info btn-lg btn-block" style="visibility: hidden;" >Make Payment</button>
										</div>	
									</div>
									<hr>
