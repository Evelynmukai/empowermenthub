            ...
            <div class="row">
              ...
              <div class="col-md-6 d-flex align-items-stretch">
                <div class="icon-box" data-aos="zoom-in" data-aos-delay="100" style="width: 100%;text-align: left;">
										<form method="post" action="" name="frmsellerlogin">
										    ...
										    <h4>Login Panel</h4>
												...
												<a href="sellerforgotpassword.php">Forgot Password?</a>
													...
													?>
													<button type="button" name="submitotp" id="submitotp" class="btn btn-info btn-lg btn-block"  onclick="return validatesellerlogin()" >Click here to Login</button>
													<?php
													} else {
													?>
													<button type="submit" name="submit" id="submit" class="btn btn-info btn-lg btn-block" onclick="return validatesellerlogin()" >Click here to Login</button>
													<?php } ?>
													<script>
	  ...
	  <div class="modal-dialog" style="max-width: 50%;">
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
	      	<button value="Login" name="submit" id="submit" class="btn btn-info button-login" type="submit" onclick="return validateotp()">Veify OTP</button>
	      </div>
	    </div>
	  </div>
	</div>
