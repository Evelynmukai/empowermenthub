...
if(isset($_POST['submit']))
{
	...
	if(isset($_SESSION['workerid']))
	{
				...
				$msgtoseller = "Your request " . $_POST['workerstatus'] . " by $rsworker[name] for $rsworker_request[task] from $rsworker_request[from_date] to  $rsworker_request[to_date] ..";
				sendmail($rsseller['email_id'], $rsseller['seller_name'] , "ZimCrafts - Work Request " . $_POST['workerstatus'], $msgtoseller);
				//###Mail Code Ends here
				//###################################################
