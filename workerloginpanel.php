              ...
              <div class="col-md-6 d-flex align-items-stretch">
                <div class="icon-box" data-aos="zoom-in" data-aos-delay="100" style="width: 100%;text-align: left;">
											<form method="post" action="" name="frmworklogin">
													...
													?>
													<button type="button" name="submitotp" id="submitotp" class="btn btn-info btn-lg btn-block"  onclick="return validateworklogin()" >Click here to Login</button>
													<?php
													} else {
													?>
													<button type="submit" name="submit" id="submit" class="btn btn-info btn-lg btn-block"  onclick="return validateworklogin()" >Click here to Login</button>
													<?php } ?>
														<script>
