...
if(isset($_POST['submit']))
{
	...
	{	
		...
		else
		{
			...
			$msgtoseller = "You have got purchase request for your Artwork - $rsproduct[title]. You can contact your customer $rscustomer[customer_name] at $rscustomer[mobile_no].";
			$msgtocustomer = "You have sent purchase request for - $rsproduct[title]. To check the quality of the Artwork, you can contact $rsseller[seller_name] at $rsseller[mobile_no]. Artist's Address: $rsseller[seller_address], $rs13city[city], $rs12state[state], $rs1country[country].  ";
				//###Mail Code Starts here
				include("phpmailer.php");
				sendmail($rsseller['email_id'], $rsseller['seller_name'] , "ZimCrafts - Purchase Request from customer", $msgtoseller);
				sendmail($rscustomer['email_id'], $rscustomer['customer_name'] , "ZimCrafts - Purchase Request sent to seller", $msgtocustomer);
				//###Mail Code Ends here
				//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
				//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
				include("smsapi.php");
...
?>	
          ...
          <div class="portfolio-info">
            ...
            <ul>
              ...
              <li><strong>Artist name:</strong>: <?php echo $rsseller['seller_name']; ?></li>
