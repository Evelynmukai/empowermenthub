...
<div class="form-row">
	...
	?>
		<button type="button" name="submitotp" id="submitotp" class="btn btn-info btn-lg btn-block"  onclick="return validatecstreg()" >Click here to Register</button>
	<?php
	}
	else {
	?>
		<button type="submit" name="submit" id="submit" class="btn btn-info btn-lg btn-block"  onclick="return validatecstreg()" >Click here to Register</button>
	<?php
	}
	?>
<script>
