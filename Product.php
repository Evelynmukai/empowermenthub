...
if(isset($_POST['submit']))
{
	...
	else
	{
		...
		$sql = $sql . " , quantity, quantity_type, description, uploaded_date, status) VALUES ('','$_SESSION[sellerid]','$_POST[category]','$_POST[produce]','$_POST[variety]','". mysqli_real_escape_string($con,$_POST['title']) ."','$imgname1'";
		if($_FILES['img2']['name'] != "")
		{
		$sql = $sql . " ,'$imgname2'";
		}
...
<div class="form-row">
	...
	Quantity Type <font color="#FF0000">*</font>
	 <select name="quantitytype" id="quantitytype" class="form-control">
                                 <option value="">Select</option>
                                  <?php
								  $arr= array("Units","Kilogram","Gram","Quintal","Liter");
								  foreach($arr as $val)
								  {
