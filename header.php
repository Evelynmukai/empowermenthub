...
<head>
  ...
  <title>Zimcrafts - Online Artworks Trading Platform</title>
  <meta content="" name="Agriculture Management System is to help Artists by providing all kinds agriculture related information in the website.">
	...
	<li class="drop-down"><a href="#">Articles</a>
	  <ul>
            ...
            <li class="drop-down <?php
                            ...
                            ?>"><a href="displayproducts.php" onclick='window.location=`displayproducts.php`' >Artist's Kit</a>
              <ul>
<?php
...
?>
			...
			<li class="drop-down <?php
                            ...
                            ?>"><a href="displaysales.php" onclick='window.location=`displaysales.php`'>Artworks Market</a>
              <ul>
<?php
...
<li class="drop-down <?php
  ...
  <ul>
	...
	<li><a href="viewcstpurchasereport.php">Artist's Kit - Purchase Report</a></li>					
    <li><a href="viewpurchaserequest.php">Artworks Market - View Purchase request</a></li>
    <li><a href="viewcstpurchaseorder.php">Artworks Market - View Purchase Order</a></li>
    <li><a href="viewpurchasereport.php">Artworks Market - View Billing Report</a></li>
...
<li class="drop-down <?php
                            ...
                            ?>" ><a href="">My Account</a>
  <ul>
	<li><a href="sellerpanel.php">Artist Panel</a></li>
	...
	<li class="drop-down"><a href="#">Artworks Sales Report</a>
	  <ul>
		<?php
		/*
	...
	<li class="drop-down"><a href="#">Artist's Kit Report</a>
	  <ul>
  ...
  <ul>
	...
	<li class="drop-down"><a href="#">Report</a>
	  <ul>
		...
		<li><a href="viewseller.php">Artist Account Report</a></li>
		<li><a href="viewadminpurchasereport.php">Artist's Kit -  Product Billing Report</a></li>
		<li><a href="viewSellingProduce.php">Artworks Market -  Produce Report</a></li>
		<li><a href="viewadminpurchaserequest.php">Artworks Market -  Produce Purchase Request</a></li>
		<li><a href="viewpurchasereport.php">Artowrks Market -  Produce  Billing Report</a></li>
	  </ul>
	</li>
...
<li><a href="viewworkerrequest.php">View Worker Request</a></li>
	...
	<li class="drop-down"><a href="#">Artist's Kit</a>
	  <ul>
		...
		<li><a href="sellingproduct.php">Add  Artist's Kit</a></li>
		<li><a href="viewsellingproduct.php">View  Artist's Kit</a></li>
	  </ul>
	</li>
...
<li class="drop-down"><a href="">My Account</a>
  <ul>
	...
	<li><a href="farmerreglogin.php">As Artist</a></li>
