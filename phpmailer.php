...
function sendmail($tomail, $totmailname , $subject, $message)
{
	...
	$smtpport 	= 587;
	$mailsender = "ZimCrafts";
	$companyname= "ZimCrafts";
	$facebook = "https://www.facebook.com/ZimCrafts";
	$twitter = "https://www.twitter.com/ZimCrafts";
	$youtube = "https://www.youtube.com/ZimCrafts";
	$linkedin = "https://www.linkedin.com/ZimCrafts";
	$companyaddress  = "ZimCrafts.com";
	$contactno = "7894561230";
	$url = "www.ZimCrafts.com";
