...
$mailcontent = "
                  ...
                  <p style='padding: 0 0 0 0px;'><b>Seller Name:</b>" . $rsseller['seller_name'] . "</p>
              </td>
              <td>
              ...
              <td>
                  ...
                  <p>
                      ...
                      PIN Code: " . $rsseller['pincode']. "<br>
					  					Ph. No. " . $rsseller['mobile_no']. "</p>
              </td>
						</tr>
						</table>
						<hr>
...
<table border='1' cellspacing='0' cellpadding='0' style='border:1px solid #ccc;width: 100%;'   width='755'>
				            <tbody>
				              ...
				              <tr>
				                ...
				                <th align='left'><strong> &nbsp;Bank Name: </strong> ". $rsseller['bank_name'] . "<br>
                              &nbsp;Bank Account number: </strong> " .$rsseller['bank_acno'] . "<br>
                              &nbsp;Branch: </strong> ".$rsseller['bank_branch'] . "<br>
                               &nbsp;IFSC Code: </strong> ". $rsseller['bank_IFSC'] . "<br>
                                </th>
			                  </tr>
			                </tbody>
</table>";
//Mail Code Starts here
    ...
    sendmail($rsseller['email_id'], $rsseller['seller_name'] , "ZimCrafts Artist's Artwork Payment Receipt", $mailcontent);
//Mail Code Ends here
