		...
		else
		{
			...
			else
			{
				...
				else
				{
					...
					$msgtoworker = "You have got work request from " . $rsseller['seller_name'] . " for " . $_POST['task'] . " from ". $_POST['fromdate'] . " to " .  $_POST['tilldate'] . ". Kindly login the website to approve/reject the request..";
					...
					if($smsstatus == "Enabled")
					{
						...
						$msg= "You have got work request from " . $rsseller['seller_name'] . " for " . $_POST['task'] . " from ". $_POST['fromdate'] . " to " .  $_POST['tilldate'] . ". Kindly login the website to approve/reject the request..";
						send_sms($mobno,$msg);
					}
					//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
					//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
