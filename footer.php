        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              <strong>Phone:</strong> +263 776 792 078<br>
              <strong>Email:</strong> info@zimcrafts.co.zw<br>
            </p>
          </div>
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="displayproducts.php">Artist's Kit</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="displaysales.php">Artworks Market</a></li>
            </ul>
          </div>
