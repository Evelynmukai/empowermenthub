...
<a href="customerforgotpassword.php">Forgot Password?</a>
	...
	?>
	<button type="button" name="submitotp" id="submitotp" class="btn btn-info btn-lg btn-block"  onclick="return validatecstlogin()" >Click here to Login</button>
	<?php
	}
	else {
	?>
	<button type="submit" name="submit" id="submit" class="btn btn-info btn-lg btn-block"  onclick="return validatecstlogin()" >Click here to Login</button>
	<?php } ?>
	<script>
